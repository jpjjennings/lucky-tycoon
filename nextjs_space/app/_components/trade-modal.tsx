  ...
  if (tradeOffer?.status === 'pending') {
    ...
    return (
      <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-sm flex items-center justify-center p-4">
        ...
        >
          <h2 className="font-display font-bold text-lg text-cyan-300 mb-4">🤝 Trade Offer</h2>
      ...
      >
        ...
        <div className="mb-4">
          ...
          <div className="flex gap-2">
            {otherPlayers.map((p: Player) => (
              <button
                key={p.id}
                onClick={() => { setTargetId(p.id); setReceiveProps([]); }}
        ...
        <div className="flex gap-2 mt-4">
          <Button
            ...
            disabled={giveMoney === 0 && receiveMoney === 0 && giveProps.length === 0 && receiveProps.length === 0}
